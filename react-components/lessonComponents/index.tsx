...
const LessonComponent: FC<LessonProps> = ({ lesson, show }) => {
  return (
    <div className=" relative flex flex-col items-center w-full h-3/4 m-5 ">
      {/* <a href="#"> */}
      <img
      ...
      <div className="text-center rounded-b-lg  w-4/5 ">
        <div className="text-gray-700 h-10 lg:text-lg  font-bold md:text-xm h-5">{!show && lesson.name}</div>
        ...
        <button className="border border-white rounded-lg px-3 text-gray-400 font-semibold ">Live</button>
      </div>
      {show && (
