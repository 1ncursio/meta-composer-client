...
import ConcoursResultItem from '@react-components/Concours/concoursResultItem';
import useSWR from 'swr';
import fetcher from '@lib/api/fetcher';
import { useRouter } from 'next/router';

const ConcoursResult = () => {
  const router = useRouter();
  const { data: top, error } = useSWR<[]>(`/youtubes/playlist3topview/${router.query.id}`, fetcher);
  console.log(top);
