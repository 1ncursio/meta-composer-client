import CONST from '@lib/midi/CONST.js';
  ...
  General: {
    ...
    'Sheet Music': [
      ...
      },
      {
        ...
        value: false,
        onChange: (ev) => setSetting('sheetHighlightActiveNotes', ev.target.checked),
      },
      {
        type: 'color',
    ...
    'On Screen Piano': [
      ...
      },
      {
        ...
        value: true,
        onChange: (ev) => setSetting('highlightActivePianoKeys', ev.target.checked),
      },
  ...
  Video: {
    ...
    Particles: [
      ...
      // { type: "label", label: "Particle Presets:" },
      {
        ...
        value: 'Default',
        list: [],
        renameCallback: (item, setHtmlCallback) => renameParticlePreset(item, setHtmlCallback),
      ...
      // { type: "label", label: "Particle Types:" },
      {
        ...
        value: 'Default',
        list: [],
        renameCallback: (item, setHtmlCallback) => renameParticleType(item, setHtmlCallback), //TODO
