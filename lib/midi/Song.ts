...
export default class Song {
  ...
  controlEvents: never[];
  temporalData: any;
  sustainsByChannelAndSecond: any;
  header: any;
  tracks: any;
  markers: never[];
  otherTracks: never[];
  ...
  constructor(midiData, fileName: string, name: string, copyright: string, onready) {
  ...
  getTimeSignature(): TimeSignature[] | TimeSignature {
